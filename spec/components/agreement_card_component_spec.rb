...
RSpec.describe AgreementCardComponent, type: :component do
  ...
  let(:agreement) { create(:agreement, project: project, initiator: user, other_party: other_user) }

  describe "render?" do
    it "renders when agreement is present" do
      component = described_class.new(agreement: agreement, current_user: user)
  ...
  describe "rendering" do
    it "renders as tr element" do
      render_inline(described_class.new(agreement: agreement, current_user: user))
  ...
  describe "party cell" do
    ...
    it "shows project owner name for other party" do
      render_inline(described_class.new(agreement: agreement, current_user: other_user))
  ...
  describe "actions cell" do
    ...
    it "hides actions when show_actions is false" do
      render_inline(described_class.new(agreement: agreement, current_user: user, show_actions: false))
